...
Base = 'https://www.dropbox.com/s/adgeqplqyzbj2qi/listas.xml?dl=0' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.tv box merida') #    modificar("el nombre de tu addons")
